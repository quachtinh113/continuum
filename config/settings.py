...
RISK_PER_TRADE_PERCENT: float = _float("RISK_PER_TRADE_PERCENT", 0.5)
RISK_PER_TRADE_PERCENT_GOLD: float = _float("RISK_PER_TRADE_PERCENT_GOLD", 0.8)
...
BREAK_EVEN_ACTIVATION_ATR_MULTIPLIER: float = _float("BREAK_EVEN_ACTIVATION_ATR_MULTIPLIER", 1.5)
